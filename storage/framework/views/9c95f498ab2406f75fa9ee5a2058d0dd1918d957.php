                                ...
                                <div class="details col-xl-7 col-lg-12 col-md-12 mt-4 mt-xl-0">
                                    <div class="mt-2 mb-4">
                                        <div style="text-align: center; border: 2px solid rgb(18, 140, 170); padding: 20px;">
                                            <h3 class="mb-3 fw-semibold">الإسم الكامل: <?php echo e($ccp->name); ?></h3>
                                            <p>السبب: <?php echo e($ccp->description); ?></p>
                                            <p>Ccp  :<?php echo e($ccp->ccps); ?></p>
                                        </div>
                                        </div>
                                    </div>
                ...
                <div class="card-body">
                    <ul id="lightgallery" class="list-unstyled row">
                      ...
                      <div class="col-md-3 text-right">
                        <a href="<?php echo e(route('edit_user',['ccp'=>$ccp['id']])); ?>" class="edit-button btn btn-primary">تعديل</a>
                    </div>
...
<?php echo $__env->make('thisuser', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\allproj\auth\auth\resources\views/show_user.blade.php ENDPATH**/ ?>