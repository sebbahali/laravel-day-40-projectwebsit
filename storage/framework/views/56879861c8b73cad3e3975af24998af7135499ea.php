    ...
    <div class="side-app">
        ...
        <div class="main-container container-fluid">
            ...
            <div class="page-header">
                <h1 class="page-title">إضافة زبون غير جاد </h1>
                <div>
                    <ol class="breadcrumb">
                ...
                <div class="col-xl-8">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">إضافة زبون غير جاد </h3>
                        </div>
...
<?php echo $__env->make('this', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\allproj\auth\auth1\resources\views/add_sellerr.blade.php ENDPATH**/ ?>