...
<body class="app sidebar-mini ltr light-mode">
 ...
 <a href="javascript:void(0)" data-bs-toggle="dropdown" class="nav-link leading-none d-flex">
    <img src="<?php echo e(asset('storage/' . $user->path1)); ?>" width="200" height="100" alt="profile-user"
  ...
  <div class="drop-heading">
       ...
       <?php endif; ?>
                                                ...
                                                <a class="dropdown-item" href="<?php echo e(route('infoo')); ?>">
                ...
                <div class="app-sidebar">
                    ...
                    <div class="main-sidemenu">
                        ...
                        <ul class="side-menu">
                            ...
                            <li class="slide">
                                <a class="side-menu__item has-link" data-bs-toggle="slide" href="home_seller"><i
											...
											<div class="tab-content">
												<div class="tab-pane active" id="side21">
													<ul class="sidemenu-list">
                                                        ...
                                                        <li><a href="<?php echo e(route('infoo')); ?>" class="slide-item"> تعديل الحساب</a></li>
                                                        <li><a href="<?php echo e(route('logout')); ?>" class="slide-item"> تسجيل الخروج</a></li>
                ...
                <div class="side-app">
                    ...
                    <div class="main-container container-fluid">
                        ...
                        <div class="page-header">
                            ...
                            <div>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0)">كيف يعمل الموقع </a></li>
                                </ol>
                            </div>
                        </div>
                        <!-- PAGE-HEADER END -->
                                    ...
                                    <div class="card-body">
                                        <div class="item-box text-center">
                                            ...
                                            <div class="item-box-wrap">
                                                <h5 class="mb-2">الزبون الغير جاد</h5>
                                                <p class="text-muted mb-0">يتسبب الزبون الغير جاد في العديد من الأضرار للتاجر، فقد يقوم بإضاعة وقت وجهد الموظفين في التعامل معه دون أي عائد مالي. كما أنه قد يؤدي إلى زيادة نسبة الإلغاءات والمرتجعات في حالة شراء المنتجات أو الخدمات دون جدوى، مما يؤثر سلبًا على الأرباح </p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card service">
                                    <div class="card-body">
                                        <div class="item-box text-center">
                                            ...
                                            <div class="item-box-wrap">
                                                <h5 class="mb-2"> الوقت</h5>
                                                <p class="text-muted mb-0">يعتبر الوقت عاملاً مهمًا جدًا للتاجر ، حيث يؤثر بشكل مباشر على نجاحه و تضيع الوقت في تعامل مع زبائن غير جادين يؤثر سلبا على نجاح التجارة
                                                    لهدا من الأحسن استغلال الوقت في خدمة زبائن مهتمين بالسلعة او الخدمة المعروضة و يملكون نية الشراء </p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card service">
                                    <div class="card-body">
                                        <div class="item-box text-center">
                                            ...
                                            <div class="item-box-wrap">
                                                <h5 class="mb-2">طريقة عمل الموقع</h5>
                                                <p class="text-muted mb-0">بمساهمة التجار في اضافتهم الزبائن الغير جاديين للموقع سيعود الامر بفائدة لهم حيث يصبح من سهل التحقق من خلفية الزبون </p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card service">
                                    <div class="card-body">
                                        <div class="item-box text-center">
                                            ...
                                            <div class="item-box-wrap">
                                                <h5 class="mb-2">مشاركة </h5>
                                                <p class="text-muted mb-0">شارك الموقع لأي تاجر لمساعدة نجاح الفكرة وتسهيل عملك مستقبلا</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-xl-10 col-lg-9">
                                                <div class="mt-1">
                                                    <h4 class="fw-semibold">فكرة من الموقع</h4>
                                                    <p class="mb-0"> بمجرد أن يتم إضافة الزبائن الغير جاديين إلى الموقع ، يمكن للتجار الاطلاع على سجلات سلوكهم السابقة واستخدام هذه المعلومات لتحديد ما إذا كانوا زبائنًا جادين أم لا. هذا يمكن أن يوفر للتجار الكثير من الوقت والجهد ، ويسمح لهم بتوجيه جهودهم نحو خدمة الزبائن الجادين الذين يمكن أن يساعدوا في زيادة مبيعاتهم وتحقيق أرباح أكبر.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-xl-10 col-lg-9">
                                                <div class="mt-1">
                                                    <h4 class="fw-semibold">اضافة ادلة الصور </h4>
                                                    <p class="mb-0"> تساعد فكرة إضافة صور كادلة عند إضافة الزبائن الغير جاديين على تحسين تجربة التجار وتحديد الزبائن الذين يجب تجنبهم. فمثلاً ، إذا قام الزبون الغير جاد بطلب المنتج في محادثة او عن طريق الهاتف  يمكن للتاجر التقاط صورة للشاشة ثم استخدام هذه الصورة عند االإضافة لتوضيح ما إذا كان الزبون يحاول التسوق فقط للتسلية  هذا يمكن أن يساعد التجار على تحديد الزبائن الجادين وتوجيه جهودهم لخدمتهم .</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-xl-10 col-lg-9">
                                                <div class="mt-1">
                                                    <h4 class="fw-semibold">وصف كامل لسبب</h4>
                                                    <p class="mb-0">وصف كامل لسبب إضافة الزبون الغير جاد إلى الموقع مهم جدا  
                                                        حيث يساعد هذا الوصف التاجر على فهم الأسباب التي دفعت االتاجر إلى اضافة الزبون كغير جاد، ويساعد الوصف أيضًا التاجر من خلال ذلك الاستفادة من تجاربومعرفة كيفية التعامل مع الزبائن الغير جادين في المستقبل </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-xl-10 col-lg-9">
                                                <div class="mt-1">
                                                    <h4 class="fw-semibold">مشاركة الموقع</h4>
                                                    <p class="mb-0">تعتبر مشاركة الموقع  أمرًا مهمًا للتاجر، 
                                                        حيث يساعد على نشر الوعي بأهمية تجنب التعامل مع هذه الفئة من الزبائن كما أن مشاركة الموقع تساهم في 
                                                        زيادة حجم قاعدة البيانات بالتالي زيادة فرص نجاح الموقع مما يساعد نجاحك إنشاء الله  في عالم التجارة الإلكترونية، لذلك
                                                         يعد مشاركة الموقع بمثابة دعم وتشجيع للأعمال التجارية الصغيرة والمتوسطة.
...
</html><?php /**PATH C:\wamp64\www\allproj\auth\auth1\resources\views/home_seller1.blade.php ENDPATH**/ ?>