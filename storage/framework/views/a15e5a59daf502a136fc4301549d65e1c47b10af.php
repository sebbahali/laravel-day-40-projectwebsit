    ...
    <div class="side-app">
        ...
        <div class="main-container container-fluid">
            ...
            <div class="page-header">
                <h1 class="page-title">تعديل إضافة لمتجر   </h1>
                <div>
                    <ol class="breadcrumb">
                ...
                <div class="col-xl-8">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">تعديل إضافة لمتجر   </h3>
                        </div>
                        <form method="post" action="<?php echo e(route('edit3',['stor'=>$stor['id']])); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                        <div class="card-body">
                            <div class="row">
...
<?php echo $__env->make('thisuser', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\allproj\auth\auth\resources\views/edit_store.blade.php ENDPATH**/ ?>