            ...
            <div class="row">
                ...
                <div class="col-xl-8">
                    <div class="card">
                        ...
                        <form action="<?php echo e(route('update1', $user->id)); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control" name="password" id="exampleInputname1" placeholder=" كلمة السر">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control" name="password_confirmation" id="exampleInputname1" placeholder="تأكيد كلمة السر">
                                </div>
                            </div>
                        </div> 
...
<?php echo $__env->make('thisuser', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\allproj\auth\auth\resources\views/info1.blade.php ENDPATH**/ ?>