 ...
 <a href="javascript:void(0)" data-bs-toggle="dropdown" class="nav-link leading-none d-flex">
  ...
  <div class="drop-heading">
       ...
       <?php endif; ?>
                                                ...
                                                <a class="dropdown-item" href="home_user">
                                                    <i class="dropdown-icon fe fe-user"></i> الرئيسية
                                                </a>

                                                <a class="dropdown-item" href="<?php echo e(route('info1')); ?>">
                ...
                <div class="app-sidebar">
                    ...
                    <div class="main-sidemenu">
                        ...
                        <ul class="side-menu">
                            ...
                            <li class="slide">
                                <a class="side-menu__item has-link" data-bs-toggle="slide" href="home_user"><i
											...
											<div class="tab-content">
												<div class="tab-pane active" id="side1">
													<ul class="sidemenu-list">
                                                        ...
                                                        <li><a href="addccp" class="slide-item">    إضافة حساب بريدي</a></li>
                                                        <li><a href="addstore" class="slide-item">    إضافة متجر </a></li>
											...
											<div class="tab-content">
												<div class="tab-pane active" id="side9">
													<ul class="sidemenu-list">
                                                        ...
                                                        <li><a href="search_user" class="slide-item"> البحث في قائمة </a></li>
											...
											<div class="tab-content">
												<div class="tab-pane active" id="side13">
													<ul class="sidemenu-list">
                                                        ...
                                                        <li><a href="all2" class="slide-item"> جميع إضافاتي</a></li>
											...
											<div class="tab-content">
												<div class="tab-pane active" id="side21">
													<ul class="sidemenu-list">
                                                        ...
                                                        <li><a href="<?php echo e(route('info1')); ?>" class="slide-item"> تعديل الحساب</a></li>
											...
											<div class="tab-content">
												<div class="tab-pane active" id="side29">
													<ul class="sidemenu-list">
                                                        ...
                                                        <li><a href="terms" class="slide-item">شروط الإستخدام</a></li>
                                                        <li><a href="about" class="slide-item">من نحن </a></li>
													</ul>
...
</html><?php /**PATH C:\wamp64\www\allproj\auth\auth1\resources\views/thisuser.blade.php ENDPATH**/ ?>