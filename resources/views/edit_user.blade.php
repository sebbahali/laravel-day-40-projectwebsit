            ...
            <div class="row">
                        ...
                        <div class="card-body">
                            <div class="text-center chat-image mb-5">
                                <div class="avatar avatar-xxl chat-profile mb-3 brround">
                                    <a class="" href="home_user"><img alt="avatar" src="{{ asset('storage/' . $user->path1) }}" class="brround"></a>
                                </div>
                ...
                <div class="col-xl-8">
                    <div class="card">
                        ...
                        <form method="post" action="{{route('edit2',['ccp'=>$ccp['id']])}}" enctype="multipart/form-data">                            @csrf
                        <div class="card-body">
                            <div class="row">
