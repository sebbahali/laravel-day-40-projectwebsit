                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="name" value="{{ old('name', $user->name) }}" id="exampleInputname" placeholder="First Name">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1"> بريد الإلكتروني</label>
                                    <input type="email" class="form-control" name="email" value="{{ old('email', $user->email) }}" id="exampleInputEmail1" placeholder="Email address">
                                </div>
                                <div class="col-lg-6 col-md-12">
                                    <div class="form-group">
