                                ...
                                <div class="details col-xl-7 col-lg-12 col-md-12 mt-4 mt-xl-0">
                                    <div class="mt-2 mb-4">
                                        <div style="text-align: center; border: 2px solid rgb(18, 140, 170); padding: 20px;">
                                            <h3 class="mb-3 fw-semibold">الإسم الكامل: {{ $stor->name }}</h3>
                                            <p>السبب: {{ $stor->description }}</p>
                                            <p>رقم الهاتف: {{ $stor->number }}</p>
                                          </div>
                                        </div>
                                    </div>
                ...
                <div class="card-body">
                    <ul id="lightgallery" class="list-unstyled row">
                      ...
                      <div class="col-md-3 text-right">
                        <a href="{{route('edit_store',['stor'=>$stor['id']])}}" class="edit-button btn btn-primary">تعديل</a>
                    </div>
